...
export class Login extends React.Component<ILoginProps, ILoginState> {
  ...
  onFormDataChanged = (e, { name, value }) => {
    if (name == 'rememberMe') this.setState(prevState => ({ rememberMe: !this.state.rememberMe }));
    // @ts-ignore
    else this.setState(prevState => ({ [name]: value }));
  };
            ...
            <Segment stacked>
              <Form size="big" onSubmit={this.onSubmit}>
                ...
                <Form.Group inline widths="equal">
                  ...
                  <Form.Checkbox onChange={this.onFormDataChanged} checked={this.state.rememberMe} name="rememberMe" label="Remember Me" />
                </Form.Group>
              </Form>
