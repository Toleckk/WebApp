...
export class Registration extends React.Component<IRegistrationProps, IRegistrationState> {
  ...
  //                     <Segment stacked>
  //                         <Form>
  //                             <ValidableInput fluid name="username" placeholder="Username"/>
  //                             <Form.Input fluid name="email" placeholder="Email"/>
  //                             <Form.Input fluid name="firstPassword" type="password" placeholder="Password"/>
  //                             <Form.Input fluid name="secondPassword" type="password" placeholder="Password confirmation"/>
  //                         </Form>
  //                     </Segment>
  //                 </Grid.Column>
  //             </Grid.Row>
