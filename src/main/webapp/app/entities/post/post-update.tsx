    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="webApp.post.home.createOrEditLabel">Create or edit a Post</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : postEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="post-resource" type="text" name="resource" />
                </AvGroup>
                <AvGroup>
                  <Label for="owner.login">Owner</Label>
                  <AvInput id="post-owner" type="select" className="form-control" name="ownerId">
                    <option value="" key="0" />
                    {users
